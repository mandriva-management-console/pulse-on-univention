...
static PyMethodDef _cffi_methods[] = {
  {"getpwuid", _cffi_f_getpwuid, METH_O},
  {"_cffi_layout_struct_passwd", _cffi_layout_struct_passwd, METH_NOARGS},
...
PyMODINIT_FUNC
PyInit__cffi__xb04c3c3bxacacda2d(void)
{
  PyObject *lib;
