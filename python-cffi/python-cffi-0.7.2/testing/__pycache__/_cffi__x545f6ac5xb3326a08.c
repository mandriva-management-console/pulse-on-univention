...
/*hi there <testing.test_zdistutils.TestDistUtilsCPython object at 0xa71d61c>!2*/
#include <math.h>
...
static struct PyModuleDef _cffi_module_def = {
  ...
  "TestDistUtilsCPythontest_compile_module",
  NULL,
  -1,
  _cffi_methods,
  NULL, NULL, NULL, NULL
...
PyMODINIT_FUNC
PyInit_TestDistUtilsCPythontest_compile_module(void)
{
  PyObject *lib;
