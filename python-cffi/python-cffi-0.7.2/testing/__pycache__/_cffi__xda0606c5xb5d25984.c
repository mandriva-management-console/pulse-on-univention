...
/*9<testing.test_zdistutils.TestDistUtilsCPython object at 0xa7bfdc4>*/
...
static PyMethodDef _cffi_methods[] = {
  {"test1eoes", _cffi_f_test1eoes, METH_O},
...
PyMODINIT_FUNC
PyInit__cffi__xda0606c5xb5d25984(void)
{
  PyObject *lib;
